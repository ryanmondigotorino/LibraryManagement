...
<div class="signup_container">
    <div class="row">
        ...
        <div class="col-lg-6 col-xl-6 signup_form">
            ...
            <form action="{{route('landing.home.sign-up-submit')}}" class="global-landing-form">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-12 mt-3">
                        <button class="btn btn-default pull-right global-landing-form-btn" style="background-color:#800; color:#fff;" type="submit">SIGN UP</button>
                    </div>
                </div>
            </form>
        </div>
