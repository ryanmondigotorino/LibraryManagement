            ...
            <div class="card" style="width:100%">
                <div class="card-body">
                    <div class="profile_content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-striped table_shad table-bordered table-hover global-accounts-table" data-url="{{route('admin.dashboard.accounts.get-admins-account')}}" data-type="librarian" data-loader="{{URL::asset("public/icons/loading.gif")}}">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Status</th>
            ...
            <div class="modal-body">
                <form action="{{route('admin.dashboard.accounts.add-admins-account')}}" class="global-landing-form">@csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-secondary global-landing-form-btn">Create Librarian</button>
                    </div>
                </form>
            </div>
        </div>
