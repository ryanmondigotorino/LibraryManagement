                                ...
                                <form action="{{route('admin.books.add-books-save')}}" class="add-books">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group img-group">
                                                    <img src="{{URL::asset('storage/uploads/book_images/noimage.png')}}" id="book-front-picture" class="item_image btn_book-front-picture" alt="Book Front Image">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group img-group">
                                                    <img src="{{URL::asset('storage/uploads/book_images/noimage.png')}}" id="book-back-picture" class="item_image btn_book-back-picture" alt="Book Back Image">
